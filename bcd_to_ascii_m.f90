module BCD_TO_ASCII_M
  ...
  ! 0000 - 0037: Control chars
    ...
    o'17', o'74', o'54', o'60', o'33', o'40', o'73', o'21', &  ! o'050-0057: ()*+,-./
    ...
    o'27', o'30', o'31', o'00', o'32', o'77', o'35', o'00', &  ! o'170-0177: xyz{|}~DEL
  ...
  ! National choice chars
    o'00', o'74', o'00', o'00', o'00', o'00', o'13', o'00', &  ! o'300-0307: ÀÁÂÃÄÅÆÇ
    o'00', o'53', o'00', o'00', o'00', o'00', o'00', o'00', &  ! o'310-0317: ÈÉÊËÌÍÎÏ
    o'60', o'00', o'00', o'00', o'00', o'00', o'14', o'00', &  ! o'320-0327: ÐÑÒÓÔÕÖ×
    o'00', o'00', o'00', o'00', o'00', o'00', o'34', o'00', &  ! o'330-0337: ØÙÚÛÜÝÞß

    o'00', o'74', o'00', o'00', o'00', o'00', o'13', o'00', &  ! o'340-0347: àáâãäåæç
    o'00', o'53', o'00', o'00', o'00', o'00', o'00', o'00', &  ! o'350-0357: èéêëìíîï
    o'60', o'00', o'00', o'00', o'00', o'00', o'14', o'00', &  ! o'360-0367: ðñòóôõö÷
    o'00', o'00', o'00', o'00', o'00', o'00', o'34', o'00'  &  ! o'370-0377: øùúûüýþÿ
  /
...
!  Rows        b                     8 8 8 8 8
!  ===========================================
!  No zone       1 2 3 4 5 6 7 8 9 0 Æ Ö : > {  000-017 = 00-0F
!  0  zone A   ^ / S T U V W X Y Z | , Þ ~ \ "  020-037 = 10-1F
!  11 zone B   - J K L M N O P Q R ! É * ] ; _  040-057 = 20-2F
!  12 zone BA  Ð A B C D E F G H I ? . Á [ < }  060-077 = 30-3F
!
!  | is 0-2-8, and ^ has no input punch
!  (it may punch as zero on output).
!
!  Differences:     12  0    11     0 12  0     0 12
!                       2  3  3  4  4  4  5  7  7  7
!                       8  8  8  8  8  8  8  8  8  8
!  =================================================
!    Pierce Primary  &  |  #  $  @  %  )  ~  {  "  }
...
!         Icelandic  Ð  |  Æ  É  Ö  Þ  Á  ~  {  "  }
  ...
  integer, parameter :: Icelandic_Encoding = 4
  character, parameter :: CodeCodes(pierce_a_encoding:icelandic_encoding) = &
    & (/'A','H','S','I'/) ! Command-line options
  integer :: Encoding = Pierce_A_Encoding

  character(63), parameter :: &
    & Encodings(pierce_a_encoding:icelandic_encoding) = (/ &
    & '1234567890#@:>{^/STUVWXYZ|,%~\"-JKLMNOPQR!$*];_&ABCDEFGHI?.)[<}',  &
    & '1234567890='':>{^/STUVWXYZ|,(~\"-JKLMNOPQR!$*];_+ABCDEFGHI?.)[<}', &
    & '1234567890#@:>(^/STUVWXYZ'',%=\+-JKLMNOPQR!$*];_&ABCDEFGHI?.)[<"', &
    & '1234567890ÆÖ:>{^/STUVWXYZ|,Þ~\"-JKLMNOPQR!É*];_ÐABCDEFGHI?.Á[<}'/)

  character :: BCD_TO_ASCII(0:66) = (/ &
    !            Octal
    ! Pierce       BCD     Card             1401
    !  A         BA8421    Code       Note  NAME
...
! gfortran 4.4.7 2012031 refuses to compile these:
...
contains
  ...
  integer function Char_To_Digit ( Char ) result ( Num )
    ! Convert a character to a 1401 signed digit
  ...
  subroutine Fill_Encoding ( Encoding )
    ! Fill BCD_to_ASCII and ASCII_to_BCD from Encoding, which is 63
    ! characters in BCD order.  BCD 000 is assumed to be blank in every encoding
    character(63), intent(in) :: Encoding
    integer :: I, J
    do j = 1, 63
      bcd_to_ascii(j) = encoding(j:j)
      i = iachar(bcd_to_ascii(j))
      ! lower-case to upper-case conversion, to make sure later upper-case to
      ! lower-case mapping works
      if ( i >= 97 .and. i <= 122 ) i = i - 32   ! Latin-1 lower case
      if ( i >= 224 .and. i <= 255 ) i = i - 32  ! national choice lower case
      ascii_to_bcd(i) = j
      ! Lower case letters in Latin-1
      if ( i >= 65 .and. i <= 90 ) ascii_to_bcd(i+32) = j
      ! Lower case letters in national choice area of 8859-1
      if ( i >= 192 .and. i <= 223 ) ascii_to_bcd(i+32) = j
    end do
  end subroutine Fill_Encoding

  subroutine Init_BCD_to_Ascii
    at = bcd_to_ascii(b_at)
    dev = bcd_to_ascii(b_percnt)
    hash = bcd_to_ascii(b_hash)
    plus = bcd_to_ascii(b_amper)
  end subroutine Init_BCD_to_Ascii

end module BCD_TO_ASCII_M

!>> 2011-08-14 ASCII ~ maps to B_WM
!>> 2017-07-28 Work around gfortran 4.4.7 bug in Equivalence
